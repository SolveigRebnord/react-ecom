...
<img src="/check.svg" className="w-20" />
        ...
        <div className="flex flex-col justify-center items-center gap-4 ">
        <p className="text-base">Order Number: <span className="font-semibold">004043338632</span></p>
        ...
        <Link to={'/products'}><UnderlineLink className="text-sm text-mainYellow font-semibold">Find more products</UnderlineLink> </Link>
        </div>
