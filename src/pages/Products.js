            ...
            >
              ...
              <div className="mt-4 flex flex-col justify-end items-start gap-3">
                ...
                {product.price == product.discountedPrice ? (
                  <p className="pPrize">
                    {product.price} <PNOK>NOK</PNOK>
                  </p>
                ) : (
                  <div className="flex flex-row justify-start gap-6 items-baseline w-full">
                    <p className="line-through font-light text-base">
                      {product.price}
                    </p>
                    <p className="pPrize">
                      {product.discountedPrice} <PNOK>NOK</PNOK>
                    </p>
                  </div>
                )}
                ...
                >
                  <BeigeBtnS className="w-full bg-white text-mainBrown border-2 border-gray-100 shadow-md rounded-none py-3 px-0 md:rounded-sm md:py-2 hover:border-mainBrown hover:bg-mainBrown hover:text-white">
                    Go to product
                  </BeigeBtnS>
                </Link>
              </div>
