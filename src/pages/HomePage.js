    ...
    return (
        ...
        <section className="mx-8 my-8 mb-16 md:mx-14 md:flex flex-row-reverse justify-between items-center md:mb-20 lg:mx-80 lg:mt-12">
            <div className="relative">
                ...
                <img className="rounded-md md:rounded-none w-full max-h-80 object-cover object-bottom md:max-h-[450px] md:w-[370px] z-30" src="/header_img.jpg" />
            ...
            <div className="mt-4">
                ...
                <div className='my-6'>
                    <Link to={'/products'}><BeigeBtnS className='rounded-none md:rounded-md w-full  lg:mt-8'>All products</BeigeBtnS></Link>
                </div>
            </div>
        </section>
        <section className='bg-mainBrown text-white py-14 flex flex-col gap-10 mt-14 md:flex-row md:justify-evenly'>
            <div className='flex flex-col items-center justify-center text-center gap-4'>
                ...
                <p>Free shipping over 499 NOK <br/>Always free returns</p>
            </div>
            <div className='flex flex-col items-center justify-center text-center gap-4'>
            ...
            <div className='flex flex-col items-center justify-center text-center gap-4'>
                ...
                <p>Our main goal is substaining <br/> an eco system for the next generation</p>
            </div>
        </section>
        <section className='my-20 lg:mx-32'>
            ...
            {firstThree.map((product) => (
                <div key={product.id} className="w-3/4 flex flex-col md:w-full md:p-4 border-2 border-mainBrown p-4 rounded-md md:border-none">
                    ...
                    <div className="mt-2 w-full ">
                        <div>
                            ...
                            <div className='h-16'>
                                <p className="pPrize text-right mt-4">{product.price} NOK</p>
                            </div>
                        : <div className='flex flex-row justify-end gap-6 items-baseline w-full h-16 mt-4 md:gap-0 md:justify-between lg:justify-end lg:gap-2'>
                            <p className="line-through font-light text-xs lg:text-sm">{product.price}</p>
                            <p className="pPrize">{product.discountedPrice} NOK</p>
                        </div>}
                            </div>
                            <Link to={`/product/${product.id}`} className='w-full mx-auto my-2 lg:w-1/2'>
                                <BeigeBtnS className='w-full bg-white text-mainBrown border-2 border-mainBrown rounded-none py-3 px-0 md:rounded-sm md:py-2 hover:bg-mainBrown hover:text-white'>Go to product</BeigeBtnS>
                            </Link>
                        </div>
